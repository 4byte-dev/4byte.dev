 ...
 *
 * @method static \Modules\User\Database\Factories\UserProfileFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\Modules\User\Database\Factories\UserProfileFactory> */
    use HasFactory;

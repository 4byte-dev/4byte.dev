...
use Modules\Course\Database\Factories\CourseChapterFactory;
 ...
 *
 * @method static \Modules\Course\Database\Factories\CourseChapterFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\Modules\Course\Database\Factories\CourseChapterFactory> */
    use HasFactory;

...
use Modules\Course\Database\Factories\CourseLessonFactory;
 ...
 *
 * @method static \Modules\Course\Database\Factories\CourseLessonFactory factory($count = null, $state = [])
...
class CourseLesson extends Model implements HasMedia
{
    ...
    /** @use HasFactory<\Modules\Course\Database\Factories\CourseLessonFactory> */
    use HasFactory;

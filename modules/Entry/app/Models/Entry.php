...
namespace Modules\Entry\Models;

use App\Models\User;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsTo;
use Modules\Entry\Database\Factories\EntryFactory;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\React\Models\Comment> $comments
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Modules\React\Models\Save> $saves
 * @property-read int|null $saves_count
 * @property-read User $user
 *
 * @method static \Modules\Entry\Database\Factories\EntryFactory factory($count = null, $state = [])
...
class Entry extends Model implements HasMedia
{
    ...
    /** @use HasFactory<\Modules\Entry\Database\Factories\EntryFactory> */
    use HasFactory;

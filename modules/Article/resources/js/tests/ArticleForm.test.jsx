...
vi.mock("@/Components/Ui/Form/FormTextareaInput", () => ({
	FormTextareaInput: ({ label, placeholder }) => (
		<div>
			<label>{label}</label>
...
describe("ArticleForm", () => {
	...
	it("renders edit mode correctly", () => {
		...
		render(
			<QueryClientProvider client={queryClient}>
				<ArticleForm {...defaultProps} mode="edit" initialValues={{ title: "Existing" }} />
			</QueryClientProvider>,
		);

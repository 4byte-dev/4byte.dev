...
use Packages\User\Jobs\DeleteAccountJob;
use Packages\User\Services\SessionService;
...
class UserController extends Controller
{
    ...
    {
        $user = $request->user();
        /** @var \Packages\User\Models\UserProfile $profileModel */
    ...
    public function updateProfile(Request $request): HttpResponse
    {
        ...
        $user = $request->user();
        /** @var \Packages\User\Models\UserProfile $profile */

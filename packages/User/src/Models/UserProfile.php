...
use Packages\User\Database\Factories\UserProfileFactory;
 ...
 *
 * @method static \Packages\User\Database\Factories\UserProfileFactory factory($count = null, $state = [])
...
{
    /** @use HasFactory<\Packages\User\Database\Factories\UserProfileFactory> */
    use HasFactory;
